...
use nexus_ml::optim::{AdamW, Optimizer, SGD};
...
#[test]
fn test_training_loop_adamw() {
    let model = TinyModel::new();
    // AdamW learning rate usually higher than SGD
    let mut optimizer = AdamW::new(model.parameters(), 0.1);
